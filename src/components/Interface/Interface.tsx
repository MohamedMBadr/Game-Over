...
//
//   const games = Convert.toGames(json);
//
...
export class Convert {
    public static toGames(json: string): GamesData[] {
        return cast(JSON.parse(json), a(r("Games")));
    }

    public static gamesToJson(value: GamesData[]): string {
        return JSON.stringify(uncast(value, a(r("Games"))), null, 2);
    }
}
...
const typeMap: any = {
    "Games": o([
        ...
        { json: "freetogame_profile_url", js: "freetogame_profile_url", typ: "" },
    ], false),
    "Genre": [
        "Action RPG",
        "ARPG",
...
// To parse this data:
//
//   import { Convert, GameID } from "./file";
//
//   const gameID = Convert.toGameID(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.
