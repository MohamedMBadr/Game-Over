...
export default function OpenWorld(props: any) {
  ...
  return (<>
    {loading == true ? [<div className='d-flex justify-content-center align-items-center vh-100 '><div className="lds-ripple"><div></div><div></div></div></div>] : <div className="row  g-3 pb-5 gy-4 mt-3">
